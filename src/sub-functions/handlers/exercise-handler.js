...
export class ExerciseHandler {
    ...
    createFeedbackArea(isCorrect, explanation) {
        ...
        let markCorrectBtn = !isCorrect ? `<button class="mark-correct-btn text-xs bg-yellow-400 hover:bg-yellow-500 text-yellow-800 font-bold py-1 px-2 rounded-lg ml-4">Segna come Corretta</button>` : '';
